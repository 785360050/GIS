...
Layer_Mesh_Integrated::Layer_Mesh_Integrated(QWidget* parent /*=nullptr*/)
    : QWidget(parent)
{
    this->setWindowTitle("Layer_Mesh_Integrated");
    ...
    {
        const QString montereyRasterElevationPath = QString{"/home/jevon/ArcGIS/Runtime/Data/mspk/philadelphia.mspk"};//ETOPO
        ...
        m_integratedMeshLyr=new IntegratedMeshLayer(montereyRasterElevationPath, this);
    }
